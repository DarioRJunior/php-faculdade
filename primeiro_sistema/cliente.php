...
<table width="200" border="1">
  ...
  <tr>
    <td>Nome:</td>
    <td><input type="text" name="nome" required value="<?php echo @$_POST['nome']; ?>"></td>
  </tr>
  <tr>
    <td>Idade:</td>
    <td><input type="text" name="idade" required value="<?php echo @$_POST['idade']; ?>"></td>
  </tr>
  <tr>
    <td>Sexo:</td>
  ...
  <tr>
    <td>Telefone:</td>
    <td><input type="text" name="telefone" required value="<?php echo @$_POST['telefone']; ?>"></td>
  </tr>
  <tr>
	  <td>E-mail:</td>
